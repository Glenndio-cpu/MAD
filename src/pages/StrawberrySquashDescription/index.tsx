...
const StrawberrySquashDescription: React.FC<Props> = ({ navigation }) => {
  return (
    <View style={styles.container}>
      ...
      {/* Title */}
      <Text style={styles.title}>Strawberry Squash</Text>
      {/* Strawberry Squash SVG */}
      <StrawberrySquashSVG width={110} height={110} style={styles.coffeePhoto} />
      {/* Price Section */}
...
export default StrawberrySquashDescription; 