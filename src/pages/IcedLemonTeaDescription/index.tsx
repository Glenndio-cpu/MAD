...
const IcedLemonTeaDescription: React.FC<Props> = ({ navigation }) => {
  return (
    <View style={styles.container}>
      ...
      {/* Title */}
      <Text style={styles.title}>Iced Lemon Tea</Text>
      {/* Lemon Tea SVG */}
      <LemonTeaSVG width={110} height={110} style={styles.coffeePhoto} />
      {/* Price Section */}
...
export default IcedLemonTeaDescription; 