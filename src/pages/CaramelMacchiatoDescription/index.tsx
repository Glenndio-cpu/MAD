...
const CaramelMacchiatoDescription: React.FC<Props> = ({ navigation }) => {
  return (
    <View style={styles.container}>
      ...
      {/* Caramel Macchiato SVG */}
      <CaramelMacchiatoSVG width={110} height={110} style={styles.coffeePhoto} />
      {/* Price Section */}
...
export default CaramelMacchiatoDescription; 