...
const MangoSmoothieDescription: React.FC<Props> = ({ navigation }) => {
  return (
    <View style={styles.container}>
      ...
      {/* Title */}
      <Text style={styles.title}>Mango Smoothie</Text>
      {/* Mango Smoothie SVG */}
      <MangoSmoothieSVG width={110} height={110} style={styles.coffeePhoto} />
      {/* Price Section */}
      <Text style={styles.priceLabel}>Harga:</Text>
      <Text style={styles.priceValue}>Rp 32.000,-</Text>
      {/* Order Button */}
...
export default MangoSmoothieDescription; 